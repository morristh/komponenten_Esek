...
\end{center}
\addtocwithheader{Rekursva virsor}  % Add entry to TOC and set header\noBackground
\noBackground

\newpage
\resetBackground

Borde engineering drinking song vara rekursiv visa?
...
\begin{textblock*}{10cm}(3.0cm, 5.0cm) % {width}(x, y)
    \includegraphics[width=7cm]{./bilder/vag.png}
\end{textblock*}
...
\begin{textblock*}{10cm}(1.0cm, 1.0cm) % {width}(x, y)
    \includegraphics[width=6cm]{./bilder/roda_havet_test.png}
\end{textblock*}
...
\begin{textblock*}{10cm}(1.0cm, 1.0cm) % {width}(x, y)
    \includegraphics[width=6cm]{./bilder/plan.png}
\end{textblock*}
