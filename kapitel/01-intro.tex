...
\begin{textblock*}{6cm}(6cm,2.0cm) % {block width}(x-coordinate, y-coordinate)
...
När det skålas och det ska skålas korrekt så börjar man med att skåla med sin bordsgranne, sedan med din sekundära bordsgranne och slutligen rakt över till den mittemot. Efter dricker man ur och upprepar denna process, fast baklänges.
\\
...
\vissteduatt{En myt säger att man får börja äta av maten vid fler gäster än åtta vid bordet, detta är fel!}
