\begin{center}
    \vspace*{1.5cm}
    {\fontsize{20}{20}\textbf{\fontspec{Lucida Sans Unicode}Snapsvisor}}\\
    \vspace{0.7cm}
...
\begin{parse lines}[\noindent]{#1\\}
    ...
    Höj din bägare, o broder och syster,
    låt den svenska skogen glida kall,
    ...
    kvarten gör oss som en mänska ny
...
\songinfo{Mel: Polyushko polye \\ Ur Chalmersspexet Katarina II 1959}
...
\vissteduatt{Visste du att Vikingen skrevs av en E:are? Han heter Olof,\\kallades Öloph, och var sektionens första krøgare.}
...
\vissteduatt{Visste du att de första BME-studenterna började på LTH \\
först 2011?}
...
\begin{parse lines}[\noindent]{#1\\}
    ...
    En viking vill ha livets vann
    Hurra hurra!
    Men på sig själv han lägger ban,
    Jaha, vad bra!
...
\index[alfa]{ynglahund@Änglahund}
