...
\subsection*{Vi går på F-sek - små bokstäver??} 
...
\backgroundsetup{
  ...
  vshift=-230,
  hshift=160,
  contents={\includegraphics[width=\paperwidth]{./bilder/M.png}}
}
...
\vissteduatt{Visste du att M-sektionen fick en gammal frys av E-sektionen i 50-års \\present, som E-sektionen ville bli av med?}
...
\backgroundsetup{
  ...
  vshift=-230,
  hshift=160,
  contents={\includegraphics[width=\paperwidth]{./bilder/V.png}}
}
...
\end{parse lines}
\vissteduatt{fint om V-sek ELLER Visste du att F:s sektionsvisa skrevs av V-sektionen till en Sångarstrid?}
\newpage
...
%   vshift=-230,
%   hshift=160,
%   contents={\includegraphics[width=\paperwidth]{./bilder/A.avif}}
% }
...
\backgroundsetup{
  ...
  vshift=-230,
  hshift=160,
  contents={\includegraphics[width=\paperwidth]{./bilder/K.png}}
}
...
\backgroundsetup{
  ...
  vshift=-230,
  hshift=160,
  contents={\includegraphics[width=\paperwidth]{./bilder/D.jpg}}
}
...
\vissteduatt{Visste du att "Rosa" alltid sjunges som färgen "råsa" och att \\rimmen justerats därefter?}
\newpage
...
\vissteduatt{Visste du att D-sektionen skapade Sveriges första studentwebb och hade \\en hierarkiskt ordnad länksamling långt innan stora sidor som Yahoo?}
...
\backgroundsetup{
  ...
  vshift=-230,
  hshift=160,
  contents={\includegraphics[width=\paperwidth]{./bilder/ING.png}}
}
...
\backgroundsetup{
  ...
  vshift=-230,
  hshift=160,
  contents={\includegraphics[width=\paperwidth]{./bilder/W.png}}
}
...
(Sjungs förslagsvis tsm med playback)??????????
}
...
\vissteduatt{Visste du att TLTH har gett bort en livs levande hammarhaj som heter\\ Daisy till W-sektionen som present?}
...
\backgroundsetup{
  ...
  vshift=-230,
  hshift=160,
  contents={\includegraphics[width=\paperwidth]{./bilder/I.png}}
}
