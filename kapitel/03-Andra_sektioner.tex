...
\end{parse lines}
\vissteduatt{Visste du att F:s sektionsvisa skrevs av V-sektionen till en Sångarstrid?}
\newpage
\resetBackground
...
\vissteduatt{\colorbox{yellow}{fint om A-sek}}
...
\vissteduatt{Visste du att D-sektionen skapade Sveriges första studentwebb \\
...
\vissteduatt{\colorbox{yellow}{fint om I-sek}}
