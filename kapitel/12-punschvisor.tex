\begin{center}
    \vspace*{1.5cm}
    {\fontsize{20}{20}\textbf{\fontspec{Lucida Sans Unicode}Punschvisor}}\\
    \vspace{0.7cm}
...
\resetBackground
  ...
  \begin{parse lines}[\noindent]{#1\\} 
    ...
    Carlshamns flagg och Grönstedts blå
    och lilla Caloric
...
\newpage
  ...
  \begin{parse lines}[\noindent]{#1\\} 
    ...
    Den skall höras ända bort till Stockholms sta'
    
    Kaffe, kaffe, kaffe, konjak och likör,
    ger åt oss ikväll ett mycket gott humör
    På det ska ni ger er katten,
