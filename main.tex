...
\fancypagestyle{main}{
  ...
  %\fancyhead[RO]{\hfill \footnotesize\scshape\leftmark \hfill} % Denna raden för header på varannan sida kolla på om vi vill ha det så som D-sektionen har det.. TODO NOTE OBS
