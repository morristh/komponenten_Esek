\begin{center}
    \vspace*{1.5cm}
    {\fontsize{20}{20}\textbf{\fontspec{Lucida Sans Unicode}Teknologvisor}}\\
    \vspace{0.7cm}
...
Text: Ellinor Persson F07 \& Andreas Tågerud F06
}
...
\vissteduatt{Visste du att "han" kan enkelt bytas ut mot "hon" eller "hen"!}
...
\index[alfa]{Glädjekällan}
\index[anfa]{Som en ljuvlig glädjekälla}
\songinfo{Mel: Pärleporten\\ 
Text: Gabriel Andersson E21 \& Torgil Mitja Svensson E22\\
