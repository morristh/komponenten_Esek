...
\vissteduatt{Detta är en lång visste du att som jag hoppas är så pass lång att den tar upp lite för mycket plats. Nu fortsätter jag så att den tar ännu fler rader, jag vill helst att den ska vara så pass lång att den fyller två hela rader med text och påbörjar en tredje rad så att den speglar de längsta visste du att vi har med i boken.}
...
\vissteduatt{Vissde due add skeuåska aer ded fiejnaste spraoåked i hela vearlden?}
\newpage
...
\vissteduatt{Visste du att fler snapsvisor finns på sida...}
\newpage
%\vspace*{-4cm}
\enlargethispage{5cm}
%\vspace*{3.6cm}
