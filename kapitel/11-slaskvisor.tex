...
\begin{textblock*}{3cm}(4.8cm,7.6cm) % {width}(x, y)
    \includegraphics[width=5.2cm]{./bilder/majas-bilder/temperaturen.png}
\end{textblock*}
...
\begin{parse lines}[\noindent]{#1\\}
    ...
    Vi rullar, vi rullar…
    ... \colorbox{yellow}{KOLLA I V-sek bok}
\end{parse lines}
...
\begin{textblock*}{3cm}(1cm,10.5cm) % {width}(x, y)
